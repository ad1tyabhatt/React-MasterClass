      ...
      <section className="flex justify-around flex-wrap py-5">
        ...
        <div className="max-w-2xl text-gray-700 text-lg ">
          ...
          <p className="my-4">{movie.overview}</p>
            { movie.genres ? (
              ...
              { movie.genres.map((genre) => (
                <span className="mr-2 border border-gray-200 roundedborder-gray-600 p-2 rounded-md" key={genre.id}>{genre.name}</span>
              )) }
            </p>
            ) : "" }
          ...
          <div className="flex items-center">
              ...
              <p className="ml-2 text-gray-700">{movie.vote_average}</p>
